...
HOST = "https://dalexhd.github.io/SteamSpeak/".freeze
...
DOCS_ROOT = File.join(ROOT_DIR, "docs", "docs").freeze
DOCS_HOST = "#{HOST}#{DOCS_BASE_PATH}".freeze
GUIDES_ROOT = File.join(ROOT_DIR, "docs", "guides").freeze
HIGHLIGHTS_HOST = "#{HOST}#{HIGHLIGHTS_BASE_PATH}".freeze
HIGHLIGHTS_ROOT = File.join(ROOT_DIR, "docs", "highlights").freeze
META_ROOT = File.join(ROOT_DIR, ".meta").freeze
PAGES_ROOT = File.join(ROOT_DIR, "docs", "src", "pages").freeze
POSTS_ROOT = File.join(ROOT_DIR, "docs", "blog").freeze
REFERENCE_ROOT = File.join(ROOT_DIR, "docs", "docs", "reference").freeze
RELEASES_ROOT = File.join(ROOT_DIR, "docs", "releases").freeze
...
STATIC_ROOT = File.join(ROOT_DIR, "docs", "static").freeze
